...
חוק קריטי על סכומים: אל תמציא סכומי ₪. אם סכום מסוים אינו מופיע במפורש במידע הרשמי שקיבלת — כתוב "לסכום מעודכן יש לפנות למקור הרשמי" והפנה לקישור מ-official_sources.
"""
